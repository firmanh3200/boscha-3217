...
st.title('Statistik Ketenagakerjaan Kabupaten Bandung Barat')
...
with kol1a:
    with st.container(border=True):
        st.success('Tren Tingkat Pengangguran Terbuka (TPT) Kabupaten Bandung Barat dan Jawa Barat')
...
with kol1b:
    with st.container(border=True):
        st.info('Tren Tingkat Partisipasi Angka Kerja (TPAK) Kabupaten Bandung Barat dan Jawa Barat')
...
with st.expander('Lihat Tabel Lengkap'):
    st.warning('Indikator Ketenagakerjaan Makro Kabupaten Bandung Barat dan Jawa Barat')
