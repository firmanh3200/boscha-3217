...
st.title('Indikator Pembangunan Manusia Kabupaten Bandung Barat')
...
with st.container(border=True):
    st.success('Tren IPM Kabupaten Bandung Barat')
...
with kol1a:
    with st.container(border=True):
        st.info('Tren Pengeluaran Perkapita Disesuaikan (000 Rp) Kabupaten Bandung Barat')
...
with kol1b:
    with st.container(border=True):
        st.warning('Pertumbuhan IPM Kabupaten Bandung Barat (%)')
...
with kol2a:
    with st.container(border=True):
        st.warning('Tren Lama Sekolah di Kabupaten Bandung Barat')
...
with kol2b:
    with st.container(border=True):
        st.info('Tren Usia Harapan Hidup (UHH) di Kabupaten Bandung Barat')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Pembangunan Manusia Kabupaten Bandung Barat')
