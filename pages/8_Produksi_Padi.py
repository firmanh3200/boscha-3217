...
st.title('Produksi Padi dan Beras di Kabupaten Bandung Barat')
...
with kol1a:
    with st.container(border=True):
        st.success('Luas Panen Padi di Kabupaten Bandung Barat (Hektare)')
...
with kol1b:
    with st.container(border=True):
        st.info('Produksi Padi di Kabupaten Bandung Barat (Ton GKG)')
...
with st.expander('Produksi Beras'):        
    with st.container(border=True):
        st.success('Produksi Beras di Kabupaten Bandung Barat (Ton)')
...
with st.expander('Lihat Tabel Lengkap'):
    st.warning('Hasil Survei KSA di Kabupaten Bandung Barat')
