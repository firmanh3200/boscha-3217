...
st.title('Kemiskinan Makro Kabupaten Bandung Barat')
...
with kol1a:
    with st.container(border=True):
        st.success('Perkembangan Jumlah Penduduk Miskin di Kabupaten Bandung Barat')
...
with kol1b:
    with st.container(border=True):
        st.info('Garis Kemiskinan Kabupaten Bandung Barat')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Kemiskinan Makro Kabupaten Bandung Barat')
