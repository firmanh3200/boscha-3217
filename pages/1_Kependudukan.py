...
st.title(':orange[STATISTIK] :blue[KEPENDUDUKAN] :green[Kabupaten Bandung Barat]')
...
with st.container(border=True):
    # URL API Open Data
    url = "https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_17892_jml_penduduk__jk_kabupatenkota?limit=100&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223217%22%5D%7D"
    ...
    st.subheader('Perkembangan Jumlah Penduduk Kabupaten Bandung Barat')
    ...
    # KELOMPOK UMUR
    with tab3:
        url3 = 'https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_18305_jml_penduduk__kelompok_umur_kabupatenkota?limit=1000&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223217%22%5D%7D'
        ...
        if pilihan:
            st.subheader(f'Penduduk Kabupaten Bandung Barat menurut Kelompok Umur Tahun {pilihan}')
